...
@block("theme:branded-custom-homepage:user-badge", {
    ...
    {{#if this.currentUser}}
      <div class="block-user-badge__layout">
        ...
        <AsyncContent @asyncData={{this.loadProgress}}>
          <:content as |data|>
            {{#if data}}
              <div class="block-user-badge__progress">
                <span class="block-user-badge__progress-label">
                  {{#if data.label}}
                    {{#if data.groupName}}
                  ...
                  {{/if}}
                  <span class="block-user-badge__progress-count">
                    {{data.value}}
                    /
                    {{data.max}}
                  </span>
